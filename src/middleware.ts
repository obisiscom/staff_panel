...
export default createMiddleware({
  ...
  // Varsayılan dil
  defaultLocale,
  // Dil önekini gerektiğinde kullan
  localePrefix: 'as-needed'
});

// Middleware yapılandırmasını hangi yollarda çalıştıracağımızı belirliyoruz
export const config = {
  // `/api/`, `/_next/` ve dosya uzantılı istekler hariç tüm yolları eşleştir
  matcher: ['/((?!api|_next|.*\\..*).*)']
};
